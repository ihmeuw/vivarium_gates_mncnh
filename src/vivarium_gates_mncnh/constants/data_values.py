...
POSTPARTUM_DEPRESSION_CASE_SEVERITY_DISABILITY_WEIGHTS = {
    POSTPARTUM_DEPRESSION_CASE_TYPES.ASYMPTOMATIC: get_norm(0.0, 0.00**2),
    POSTPARTUM_DEPRESSION_CASE_TYPES.MILD: get_norm(
        0.145, ninety_five_pct_confidence_interval=(0.099, 0.209)
    ),
    POSTPARTUM_DEPRESSION_CASE_TYPES.MODERATE: get_norm(
        0.396, ninety_five_pct_confidence_interval=(0.267, 0.531)
    ),
    POSTPARTUM_DEPRESSION_CASE_TYPES.SEVERE: get_norm(
